...
function CalendarView({ childrenData, eventsData, checkpoints, auditedAt, onAudit, mode, setMode, child, setChild, onOpenEvent }: { childrenData: SchoolContext[]; eventsData: EventItem[]; checkpoints: CalendarCheckpoint[]; auditedAt: string | null; onAudit: () => void; mode: string; setMode: (v: string) => void; child: 'all' | ChildId; setChild: (v: 'all' | ChildId) => void; onOpenEvent: (event: EventItem) => void }) {
